                ...
                <div className="flex-1">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-gray-200">Ambil peran aktif dalam pelestarian lingkungan</span>
                    </div>
                  </div>
                </div>
                  <div className="flex-1">
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-4 gap-6">
              ...
              <Card className="glass-effect border-white/20 text-center p-6">
                ...
                <p className="text-gray-200 text-sm">
                  Adopsi pohon sebagai hadiah untuk orang terkasih merupakan pemberian yang memiliki dampak positif.
                </p>
              </Card>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center">
              ...
              <div className="flex justify-center space-x-6 text-sm text-gray-400">
                <span>© 2025 TreeAdopt (Kelompok 3)</span>
                <span>•</span>
